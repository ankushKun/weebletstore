        ...
        <div className="grid grid-cols-1 md:grid-cols-2 p-5 mx-auto w-fit">
            ...
            <div className="flex flex-col justify-center items-center">
                <div className=" p-1 text-center ring-1 ring-white bg-white pb-5 text-black rounded-xl my-5">
                    <Image src={qr} alt="UPI QR code" width={300} height={300} className="rounded-lg m-5" />
                    <div className="text-green-600 font-extrabold text-2xl flex items-center justify-center gap-2">
                        <Image src={upi} alt="UPI logo" height={18} className="" />₹{amount}</div>
                    <div className="text-xl">WeebletStore (Ankush Singh)</div>
                </div>
